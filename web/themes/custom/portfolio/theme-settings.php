...
function portfolio_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface $form_state, $form_id = NULL) {
  ...
  $form['#attached']['library'][] = 'portfolio/cms_settings_js';
  $form['#attached']['library'][] = 'portfolio/cms_settings_css';

  $form['portfolio_settings'] = [
    '#type' => 'vertical_tabs',
    '#weight' => -99,
  ...
  /* GOOGLE SETTINGS */
  $form['portfolio_settings']['google'] = [
    '#type' => 'details',
    '#title' => t('Google setings'),
    '#weight' => 6,
    '#group' => 'portfolio_settings',
  ];

  $form['portfolio_settings']['google']['google-analytics'] = [
    '#type' => 'fieldset',
  ...
  $form['portfolio_settings']['google']['google-analytics']['googletracker'] = [
    '#type' => 'textfield',
    '#title' => t('Tracker'),
  ...
  /* LAYOUT SETTINGS */
  $form['portfolio_settings']['layout'] = [
    '#type' => 'details',
    '#title' => t('Layout'),
    '#weight' => 2,
    '#group' => 'portfolio_settings',
  ...
  $form['portfolio_settings']['layout']['display'] = [
    '#type' => 'fieldset',
  ...
  $form['portfolio_settings']['layout']['display']['sticky-header'] = [
    '#type' => 'checkbox',
  ...
  $form['portfolio_settings']['layout']['media'] = [
    '#type' => 'fieldset',
  ...
  $form['portfolio_settings']['layout']['media']['csTopImage'] = array(
    '#type'          => 'managed_file',
    '#title'         => t('Top Image'),
  ...
  $form['portfolio_settings']['layout']['media']['csBottomImage'] = array(
    '#type'          => 'managed_file',
  ...
  $form['portfolio_settings']['layout']['media']['cs_bannerBottomTitle'] = [
    '#type' => 'textarea',
    '#rows' => '3',
    '#title' => t('Banner Bottom title'),
    '#default_value' => theme_get_setting('cs_bannerBottomTitle'),
  ];




  $form['portfolio_settings']['layout']['page-settings'] = [
    '#type' => 'fieldset',
  ...
  $form['portfolio_settings']['layout']['page-settings']['cs_pagetitle'] = [
    '#type' => 'textfield',
    '#title' => t('Homepage Title'),
    '#default_value' => theme_get_setting('cs_pagetitle'),
  ];

  $form['portfolio_settings']['layout']['page-settings']['cs_subpagetitle'] = [
    '#type' => 'textarea',
    '#rows' => '3',
  ...
  $form['portfolio_settings']['layout']['page-settings']['cs_footer'] = [
    '#type' => 'textarea',
    '#rows' => '3',
    '#title' => t('Footer'),
  ...
  $form['portfolio_settings']['layout']['page-settings']['main_phone'] = [
    '#type' => 'textfield',
    '#title' => t('Main Phone number'),
    '#default_value' => theme_get_setting('main_phone'),
  ];

  $form['portfolio_settings']['layout']['page-settings']['main_mobile'] = [
    '#type' => 'textfield',
    '#title' => t('Main Mobile Phone number'),
    '#default_value' => theme_get_setting('main_mobile'),
  ];

  $form['portfolio_settings']['layout']['page-settings']['main_address'] = [
    '#type' => 'textfield',
 ...
 /* Social SETTINGS */
 $form['portfolio_settings']['layout']['page-settings']['social'] = [
  '#type' => 'fieldset',
...
$form['portfolio_settings']['layout']['page-settings']['social']['facebook'] = [
  '#type' => 'textfield',
  '#title' => t('Facebook'),
  '#default_value' => theme_get_setting('facebook'),
];
$form['portfolio_settings']['layout']['page-settings']['social']['youtube'] = [
  '#type' => 'textfield',
  '#title' => t('Youtube'),
  '#default_value' => theme_get_setting('youtube'),
];

$form['portfolio_settings']['layout']['page-settings']['shop'] = [
  '#type' => 'fieldset',
...
$form['portfolio_settings']['layout']['page-settings']['shop']['shop_link'] = [
  '#type' => 'textfield',
  '#title' => t('Shop link'),
  '#default_value' => theme_get_setting('shop_link'),
];

  _portfolio_settings_global_tab($form);
    ...
    if ($folder){
      ...
      if (is_object($image)) {
        ...
        if (!$image->isPermanent()) {
          ...
          $file_usage->add($image, 'portfolio', 'theme', 1, $image_bottom[0], 'file' );
        ...
        if(is_object($image_bottom)) {
          if (!$image_bottom->isPermanent()) {
            ...
            // Add a reference to prevent warnings.
            $file_usage = \Drupal::service('file.usage');
            $file_usage->add($image_bottom, 'portfolio', 'theme', 1 );
            \Drupal::messenger()->addMessage('Say something else');
          }
        }
      }
...
function _portfolio_settings_global_tab(&$form) {
  // Toggles
  ...
  /* GOOGLE SETTINGS */
  $form['portfolio_settings']['global_settings'] = [
    '#type' => 'details',
    '#title' => t('Global'),
    '#weight' => 1,
    '#group' => 'portfolio_settings',
  ...
  $form['portfolio_settings']['global_settings']['logo'] = $form['logo'];
  $form['portfolio_settings']['global_settings']['favicon'] = $form['favicon'];
  $form['portfolio_settings']['global_settings']['theme_settings'] = $form['theme_settings'];
